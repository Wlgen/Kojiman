...
Background* Background::createBackground(glm::vec2 geom[2], glm::vec2 texCoords[2], ShaderProgram& program) {
	Background* back = new Background(geom, texCoords, program);
	return back;
}

Background::Background(glm::vec2 geom[2], glm::vec2 texCoords[2], ShaderProgram& program) {
	float vertices[24] = {
